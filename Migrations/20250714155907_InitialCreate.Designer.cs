...
namespace nhaHang.Migrations
{
    ...
    [Migration("20250714155907_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NhaHangChain.Models.ChiNhanh", b =>
                {
            ...
            modelBuilder.Entity("NhaHangChain.Models.ChiTietDonHang", b =>
                {
            ...
            modelBuilder.Entity("NhaHangChain.Models.DanhMuc", b =>
                {
            ...
            modelBuilder.Entity("NhaHangChain.Models.DonHang", b =>
                {
                    b.Property<string>("MaDonHang")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("NhaHangChain.Models.HoaDon", b =>
                {
            ...
            modelBuilder.Entity("NhaHangChain.Models.KhachHang", b =>
                {
                    b.Property<string>("MaKhachHang")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("NhaHangChain.Models.KhuyenMai", b =>
                {
                    b.Property<string>("MaKhuyenMai")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("NhaHangChain.Models.MonAn", b =>
                {
                    b.Property<string>("MaMonAn")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("NhaHangChain.Models.QuanTriVien", b =>
                {
            ...
            modelBuilder.Entity("NhaHangChain.Models.ChiTietDonHang", b =>
                {
                    b.HasOne("NhaHangChain.Models.DonHang", "DonHang")
                        .WithMany("ChiTietDonHangs")
                        .HasForeignKey("MaDonHang")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NhaHangChain.Models.MonAn", "MonAn")
                        .WithMany("ChiTietDonHangs")
            ...
            modelBuilder.Entity("NhaHangChain.Models.DanhMuc", b =>
                {
                    b.HasOne("NhaHangChain.Models.ChiNhanh", "ChiNhanh")
                        .WithMany("DanhMucs")
            ...
            modelBuilder.Entity("NhaHangChain.Models.DonHang", b =>
                {
                    ...
                    b.HasOne("NhaHangChain.Models.KhachHang", "KhachHang")
                        .WithMany("DonHangs")
                        .HasForeignKey("MaKhachHang")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NhaHangChain.Models.KhuyenMai", "KhuyenMai")
                        .WithMany()
            ...
            modelBuilder.Entity("NhaHangChain.Models.MonAn", b =>
                {
                    ...
                    b.HasOne("NhaHangChain.Models.DanhMuc", "DanhMuc")
                        .WithMany("MonAns")
